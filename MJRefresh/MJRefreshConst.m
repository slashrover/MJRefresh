...
NSString *const MJRefreshAutoFooterIdleText = @"Pull up to load more";
NSString *const MJRefreshAutoFooterRefreshingText = @"Loading...";
NSString *const MJRefreshAutoFooterNoMoreDataText = @"Load is done";
...
NSString *const MJRefreshBackFooterNoMoreDataText = @"Load is done";
